...
set :application, "props2me"
set :repository,  "git@github.com:brennanmeadowcroft/props2me.git"
...
role :web, "baltar.asmallorange.com"                          # Your HTTP server, Apache/etc
role :app, "baltar.asmallorange.com"                          # This may be the same as your `Web` server
role :db,  "baltar.asmallorange.com", :primary => true # This is where Rails migrations will run

set :deploy_via, :copy

set :deploy_to,	"rails_apps/props2me"
set :user,		"propsme"
set :use_sudo,	false
